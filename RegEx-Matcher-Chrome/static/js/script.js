...
document.getElementById("backdrop").addEventListener("input", matchText); // had to add this for chrome :/
document.getElementById("regex-input").addEventListener("input", matchText);
